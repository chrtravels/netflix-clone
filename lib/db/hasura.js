...
export async function insertStats(token, { userId, videoId, favorited, watched }) {
  const operationsDoc = `
  mutation insertStats($userId: String!, $videoId: String!, $favorited: Int!, $watched: Boolean!) {
...
export async function getMyList(token, userId, userId) {
  const operationsDoc = `
  query favoritedVideos($userId: String!, $videoId: String!) {
